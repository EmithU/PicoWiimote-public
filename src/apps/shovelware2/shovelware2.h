...
// Replace [CHANGE_THIS] with the name of the file, all caps
#ifndef SHOVELWARE2_H
#define SHOVELWARE2_H
...
// Replace [CHANGE_THIS] with the name of the file
void init_objs_shovelware2();
